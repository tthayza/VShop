...
public class IdentityConfiguration
{
    ...
    public static IEnumerable<ApiScope> ApiScopes =>
        new List<ApiScope>
        {
            //vshop é a aplicação web que vai acessar o token
      ...
      new List<Client>
      {
               //cliente genérico
                ...
                new Client
                {
                    ...
                    RedirectUris = {"https://localhost:7010/signin-oidc"},//login
                    PostLogoutRedirectUris = {"https://localhost:7010/signout-callback-oidc"},//logout
